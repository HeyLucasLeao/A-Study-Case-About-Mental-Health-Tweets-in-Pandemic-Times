...
app = Dash('Ansiedade & Pandemia', external_stylesheets=[dbc.themes.BOOTSTRAP])
app.layout = html.Div([

    html.H3("Ansiedade e Pandemia: Análise Exploratória no Tweets ao longo de 4 anos.", style={'text-align': 'justify-all'}),
    ...
    html.P(["""Como twitter há uma quantidade enorme de dados, estabeleci as seguintes regras:""", html.Br(),
    " - 1. Tweets a partir de retweets não serão contados.", html.Br(),
    " - 2. Os mesmos, não poderiam conter links, tampouco hashtags.", html.Br(),
    ...
    html.P(["""Ainda sim, queria mais respostas. A partir disso, procurei saber se em contextos específicos sobre o tema houve 
        ...
        " baseado nas camadas encoders dos ", html.A("Transformers.", href="https://huggingface.co/transformers/"), html.Br(),
        ...
        """O modelo pré-treinado selecionado foi o """, html.A('BERTimbau', href='https://huggingface.co/neuralmind/bert-base-portuguese-cased'), " dísponível pelo site ",
    ...
    html.P(["""Após processamento dos dados, foi identificado que 66,54% dos tweets coletados tratam-se sobre ansiedade 
            ...
            graves, como suicídio."""], style={'text-align': 'justify-all'}),
    html.Label(['Selecione o período gráfico']),
    dcc.Dropdown(
    ...
    html.P(["""Observando pelo crescimento percentual, vemos que 2019 teve um aumento de 57% 
        ...
        manifestados durante toda a questão com a saúde pública e as incertezas sobre o futuro do Brasil.""", html.Br(),
        """A partir disto, procurei entender qual seria a predição para os próximos 
